...
/* Section flags */
Elf64_Xword get_section_header_flags(void *ptr, int8_t endian) {
    if (IS_ELF64(ptr)) {
...
Elf64_Addr get_section_header_addr(void *ptr, int8_t endian) {
    if (IS_ELF64(ptr)) {
...
Elf64_Xword get_section_header_size(void *ptr, int8_t endian) {
    if (IS_ELF64(ptr)) {
...
Elf64_Word get_section_header_link(void *ptr, int8_t endian) {
    if (IS_ELF64(ptr)) {
...
Elf64_Word get_section_header_info(void *ptr, int8_t endian) {
    if (IS_ELF64(ptr)) {
...
/* Section alignment */
Elf64_Xword get_section_header_addralign(void *ptr, int8_t endian) {
    if (IS_ELF64(ptr)) {
...
Elf64_Xword get_section_header_entsize(void *ptr, int8_t endian) {
    if (IS_ELF64(ptr)) {
